...
public class FuoRepositoryFactoryBean<T extends JpaRepository<S, ID>, S, ID extends Serializable>
        extends JpaRepositoryFactoryBean<T, S, ID> {

    public FuoRepositoryFactoryBean(Class<? extends T> repositoryInterface) {
    ...
    private static class BaseRepositoryFactory<T, I extends Serializable> extends JpaRepositoryFactory {
        ...
        protected JpaRepositoryImplementation<?, ?> getTargetRepository(RepositoryInformation information, EntityManager entityManager) {
            ...
            Assert.isInstanceOf(FuoRepositoryImpl.class, repository);
        ...
        protected Class<?> getRepositoryBaseClass(RepositoryMetadata metadata) {
            return FuoRepositoryImpl.class;
        }
    }
}
